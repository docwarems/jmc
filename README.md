...
*This demo is outdated and will not entirely demonstrate the current problem. See discussion link below*
...
## Discussion
See https://github.com/openjdk/jmc/pull/333 for discussion and current status
